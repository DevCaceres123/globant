                                    ...
                                    <div class="card-body p-0 auth-header-box">
                                        ...
                                        <div class="bg-holder"
                                            ...
                                            <div class="text-center p-3" style="background-color:rgba(0, 0, 0, .1);">
                                                {{-- <img src="{{ asset('assets/logo_d.png') }}" alt="logo" class="auth-logo"
                                                    id="logo"> --}}
                                            </div>
                                        </div>
                                        ...
                                        <form id="formulario_login" autocomplete="off">
                                            ...
                                            {{-- <div class="d-flex flex-column align-items-center mt-2">
                                                ...
                                                <div class="form-floating input-placa mt-3">
                                                    ...
                                                    <label for="captcha" class="text-muted text-uppercase">Ingrese el
                                                        codigo captcha</label>
                                                </div>
                                            </div> --}}
